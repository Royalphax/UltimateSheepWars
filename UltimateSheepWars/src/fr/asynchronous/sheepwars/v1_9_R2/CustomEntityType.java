...
import fr.asynchronous.sheepwars.v1_9_R2.entity.EntityCancelMove;
import fr.asynchronous.sheepwars.v1_9_R2.entity.CustomSheep;
import fr.asynchronous.sheepwars.v1_9_R2.entity.EntityMeteor;
import fr.asynchronous.sheepwars.v1_9_R2.entity.firework.FireworkSpawner;
...
public enum CustomEntityType {
	...
	public static class GlobalMethods implements ICustomEntityType {
		...
		public Fireball spawnFireball(Location location, Player sender) {
			final EntityMeteor meteor = new EntityMeteor((net.minecraft.server.v1_9_R2.World) ((CraftWorld) location.getWorld()).getHandle(), sender);
			...
			((CraftWorld) location.getWorld()).getHandle().addEntity((net.minecraft.server.v1_9_R2.Entity) meteor);
