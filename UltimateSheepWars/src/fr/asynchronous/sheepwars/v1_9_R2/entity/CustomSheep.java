...
public class CustomSheep extends EntitySheep {
	...
	private net.minecraft.server.v1_9_R2.World world;
	...
	public CustomSheep(net.minecraft.server.v1_9_R2.World world) {
		super(world);
	}

	public CustomSheep(net.minecraft.server.v1_9_R2.World world, Player player, UltimateSheepWarsPlugin plugin) {
		super(world);
		this.player = player;
		this.plugin = plugin;
	...
	public CustomSheep(net.minecraft.server.v1_9_R2.World world, Player player,
	...
	public void move(double d0, double d1, double d2) {
		if (this.getBukkitEntity().getLocation().add(this.getBukkitEntity().getVelocity().toLocation(this.getBukkitEntity().getWorld())).getBlock().getType() != org.bukkit.Material.AIR)
			this.noclip = false;
	...
	public void g(float sideMot, float forMot) {
		if (this.sheep != null && this.onGround && this.sheep == fr.asynchronous.sheepwars.core.handler.Sheeps.REMOTE
			...
			for (net.minecraft.server.v1_9_R2.Entity passenger : this.passengers) {
