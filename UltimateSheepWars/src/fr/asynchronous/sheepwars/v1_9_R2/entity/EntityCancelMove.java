...
public class EntityCancelMove extends EntityArmorStand
{
    ...
    public void rideClientEntity() {
		final PacketPlayOutAttachEntity packet = new PacketPlayOutAttachEntity(((org.bukkit.craftbukkit.v1_9_R2.entity.CraftPlayer) player).getHandle(), this);
		sendPacket(this.player, packet);
	}
    ...
    public void unrideClientEntity() {
    	final PacketPlayOutAttachEntity packet = new PacketPlayOutAttachEntity(((org.bukkit.craftbukkit.v1_9_R2.entity.CraftPlayer) player).getHandle(), null);
		sendPacket(this.player, packet);
	}
