...
import fr.asynchronous.sheepwars.v1_10_R1.entity.EntityMeteor;
import fr.asynchronous.sheepwars.v1_10_R1.entity.firework.FireworkSpawner;
import fr.asynchronous.sheepwars.v1_10_R1.entity.EntityCancelMove;
...
public enum CustomEntityType
{
    ...
    public static class GlobalMethods implements ICustomEntityType
    {
		...
		public Fireball spawnFireball(Location location, Player sender) {
			final EntityMeteor meteor = new EntityMeteor((net.minecraft.server.v1_10_R1.World)((CraftWorld)location.getWorld()).getHandle(), sender);
	        ...
	        ((CraftWorld)location.getWorld()).getHandle().addEntity((net.minecraft.server.v1_10_R1.Entity)meteor);
