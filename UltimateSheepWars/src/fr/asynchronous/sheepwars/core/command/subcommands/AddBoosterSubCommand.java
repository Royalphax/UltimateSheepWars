...
public class AddBoosterSubCommand extends SubCommand {
	...
	public AddBoosterSubCommand(UltimateSheepWarsPlugin plugin) {
	...
	protected void onExePlayer(Player player, String... args) {
		...
		if (location.getBlock().getType() != Material.AIR) {
			...
			Hologram.runHologramTask(Message.getDecoration() + ChatColor.GREEN + " Booster location N°" + ConfigManager.getLocations(Field.BOOSTERS).size() + " " + Message.getDecoration(), player.getLocation(), 5, getUltimateSheepWarsInstance());
		}
	}
