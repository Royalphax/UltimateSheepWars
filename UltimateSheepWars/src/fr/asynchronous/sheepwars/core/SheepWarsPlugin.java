...
public class SheepWarsPlugin extends JavaPlugin {
	...
	public void onEnable() {
		...
		PlayableMap.getPlayableMap(ConfigManager.getString(Field.LOBBY_MAP_NAME)).loadWorld(Bukkit.getWorlds().get(0));
        ...
        this.register(BlockBreak.class, BlockPlace.class, BlockSpread.class, BlockExplode.class, 
        		...
        		FoodLevelChange.class, EntityDamage.class, EntityShootBow.class,
	...
	public void load()
	{
        ...
        this.world.setSpawnLocation(ConfigManager.getLocation(Field.LOBBY).toBukkitLocation(Bukkit.getWorlds().get(0)));
	...
	private void initClasses()
	{
		...
		/** Register Kits **/
		SheepWarsAPI.registerKits(this, new ArmoredSheepKit(), new BetterBowKit(), new BetterSwordKit(), new BuilderKit(), new DestroyerKit(),
				new MobilityKit(), new MoreHealthKit(), new MoreSheepKit(), new NoneKit(), new RandomKit());
		/** Register Sheeps **/
		SheepWarsAPI.registerSheeps(new BoardingSheep(), new DarkSheep(), new DistorsionSheep(), new EarthQuakeSheep(), new ExplosiveSheep(), 
				new FragmentationSheep(), new FrozenSheep(), new HealerSheep(), new IncendiarySheep(), new IntergalacticSheep(), new LightningSheep(), 
				new SeekerSheep(), new SwapSheep(), new GluttonSheep());
		if (versionManager.getVersion().newerThan(MinecraftVersion.v1_9_R1))
			SheepWarsAPI.registerSheep(new GlowingSheep());
		/** Register Boosters **/
		SheepWarsAPI.registerBoosters(new ArrowBackBooster(), new ArrowFireBooster(), new BlockingSheepBooster(), new MoreSheepBooster(),
