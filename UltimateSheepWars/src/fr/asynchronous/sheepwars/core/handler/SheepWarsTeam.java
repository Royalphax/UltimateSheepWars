...
public enum SheepWarsTeam {
	...
	SPEC("spec", Message.getMessage(Messages.SPEC_NAME), Material.STONE, DyeColor.SILVER, ChatColor.WHITE, 0, 0, 0),
	...
	public ItemStack getIcon(Player p) {
		...
		ItemBuilder item = new ItemBuilder(this.material).setColor(this.dyecolor).setName((this == BLUE ? "" + Message.getMessage(p, ChatColor.BLUE + "", Messages.JOIN_BLUE_ITEM, "") : "" + Message.getMessage(p, ChatColor.RED + "", Messages.JOIN_RED_ITEM, "")));
