...
public class ArmoredSheepKit extends KitManager {
	...
	public ArmoredSheepKit() {
		super(0, MsgEnum.KIT_ARMORED_SHEEP_NAME, MsgEnum.KIT_ARMORED_SHEEP_DESCRIPTION, "sheepwars.kit.armoredsheep", 10, 10, new ItemBuilder(Material.CHAINMAIL_CHESTPLATE));
	}
