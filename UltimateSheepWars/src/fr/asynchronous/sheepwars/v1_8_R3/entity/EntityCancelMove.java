...
public class EntityCancelMove extends EntityArmorStand
{
    ...
    public void rideClientEntity() {
		final PacketPlayOutAttachEntity packet = new PacketPlayOutAttachEntity(0x40, ((org.bukkit.craftbukkit.v1_8_R3.entity.CraftPlayer) player).getHandle(), this);
		sendPacket(this.player, packet);
	}
    
    public void unrideClientEntity() {
    	final PacketPlayOutAttachEntity packet = new PacketPlayOutAttachEntity(0x40, ((org.bukkit.craftbukkit.v1_8_R3.entity.CraftPlayer) player).getHandle(), null);
		sendPacket(this.player, packet);
	}
