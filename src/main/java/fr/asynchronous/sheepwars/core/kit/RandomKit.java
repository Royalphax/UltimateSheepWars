...
public class RandomKit extends SheepWarsKit {
	...
	public RandomKit() {
		super(9, Messages.KIT_RANDOM_NAME, true, new ItemBuilder().setSkullTexture("http://textures.minecraft.net/texture/797955462e4e576664499ac4a1c572f6143f19ad2d6194776198f8d136fdb2"), new RandomKitLevel());
	}
