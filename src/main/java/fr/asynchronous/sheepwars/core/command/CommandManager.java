...
import fr.asynchronous.sheepwars.core.command.subcommands.*;
...
public class CommandManager implements CommandExecutor {
	...
	public void showCredits(CommandSender commandSender) {
		...
		commandSender.sendMessage("∙ " + ChatColor.GRAY + "Plugin " + ChatColor.GREEN + "UltimateSheepWars v" + (UpdateManager.isUpToDate() ? "" : ChatColor.RED) + this.ultimateSheepWars.getDescription().getVersion() + ChatColor.GRAY + " by " + ChatColor.GREEN + "The Asynchronous" + ChatColor.GRAY + ".");
