...
public class PlayerData extends DataManager {
    ...
    public void setKit(SheepWarsKit kit, Integer level, boolean lastOne) {
        ...
        if (this.player.isOnline()) {
            String message;
            if (!lastOne) {
                message = Message.getMessage(this.player.getPlayer(), Messages.KIT_CHOOSE_MESSAGE);
            } else {
                message = Message.getMessage(this.player.getPlayer(), Messages.KIT_LAST_SELECTED);
            }
    ...
    public enum DataType {
        ...
        GAMES_PLAYED(0, Messages.STATS_GAME_PLAYED, "games"),
        TOTAL_DEATHS(1, Messages.STATS_DEATH, "deaths"),
        PLAYERS_KILLED(2, Messages.STATS_KILL, "kills"),
        SHEEP_THROWN(3, Messages.STATS_SHEEP_THROWN, "sheep_thrown"),
        SHEEP_KILLED(4, Messages.STATS_SHEEP_KILLED, "sheep_killed"),
