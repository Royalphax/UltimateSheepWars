...
public abstract class SheepWarsKit {
	 ...
	 */
	public SheepWarsKit(final int id, final Message.Messages name, final ItemBuilder icon, final SheepWarsKitLevel... levels) {
	 ...
	 */
	public SheepWarsKit(final int id, final Message.Messages name, final boolean freeKit, final ItemBuilder icon, final SheepWarsKitLevel... levels) {
	...
	public SheepWarsKitLevel getLevel(final Player player) {
		SheepWarsKitLevel current = new NoneKit.NullKitLevel();
	...
	public static abstract class SheepWarsKitLevel implements Listener {
		...
		public SheepWarsKitLevel(final String description, final String permission, final double price, final int requiredWins) {
			this(Message.getMessage(Message.Messages.KIT_LEVEL_DEFAULT_NAME), new Message(description), permission, price, requiredWins);
		}
		...
		public SheepWarsKitLevel(final String levelName, final Message.Messages description, final String permission, final double price, final int requiredWins) {
		...
		public SheepWarsKitLevel(final Message.Messages levelName, final String description, final String permission, final double price, final int requiredWins) {
		...
		public SheepWarsKitLevel(final Message.Messages description, final String permission, final double price, final int requiredWins) {
			this(Message.Messages.KIT_LEVEL_DEFAULT_NAME, description, permission, price, requiredWins);
		}

		public SheepWarsKitLevel(final Message.Messages levelName, final Message.Messages description, final String permission, final double price, final int requiredWins) {
		...
		public List<KitResult> canUseLevel(Player player) {
			...
			if (this.parentKit.isFreeKit() || data.getKitLevel(this.parentKit) >= this.id || (ConfigManager.getBoolean(ConfigManager.Field.ENABLE_KIT_REQUIRED_WINS) && data.getWins() >= this.wins) || (ConfigManager.getBoolean(ConfigManager.Field.ENABLE_KIT_PERMISSIONS) && player.hasPermission(this.permission)) || (Contributor.isDeveloper(player))) {
				output.add(KitResult.ALREADY_OWNED);
