...
public class GlowingSheep extends SheepWarsSheep
{
    private static final int RADIUS = 8;
    
    public GlowingSheep() {
		super(Message.Messages.GLOWING_SHEEP_NAME, DyeColor.GRAY, 10, false, true);
	}
                ...
                for (int y = -RADIUS; y < RADIUS; ++y) {
                    for (int z = -RADIUS; z < RADIUS; ++z) {
                        ...
                        if (block.getType() != Material.AIR && top.getType() == Material.AIR && MathUtils.randomBoolean()) {
                            ...
                            SheepWarsPlugin.getVersionManager().getParticleFactory().playParticles(Particles.SPELL, topLocation, 0f, 0f, 0f, 1, 0.1f);
                        }
                    }
                }
            }
