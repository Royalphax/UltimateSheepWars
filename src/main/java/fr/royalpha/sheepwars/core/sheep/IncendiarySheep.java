...
public class IncendiarySheep extends SheepWarsSheep
{
    ...
    public IncendiarySheep() {
		super(Message.Messages.INCENDIARY_SHEEP_NAME, DyeColor.ORANGE, 5, false, true, 0.8f);
	}
	...
	public void onFinish(Player player, Sheep bukkitSheep, boolean death, Plugin plugin) {
		if (!death) {
        	SheepWarsPlugin.getVersionManager().getWorldUtils().createExplosion(player, bukkitSheep.getLocation(), 4.2f, true);
        }
	}
}
