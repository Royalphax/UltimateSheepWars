...
public enum Sounds {
    ...
    public Sound bukkitSound() {
        ...
        try {
        	this.resolvedSound = Sound.valueOf(this.post19sound);
            return this.resolvedSound;
        } catch (IllegalArgumentException e) {
        	this.resolvedSound = Sound.valueOf(this.pre19sound);
            return this.resolvedSound;
        }
    }
    ...
    public static void playSoundAll(Sounds sound, float volume, float pitch)
    {
        playSoundAll(null, sound, volume, pitch);
    }
