...
public class DestroyerKit extends SheepWarsKit {
	...
	public DestroyerKit() {
		super(ID, Message.Messages.KIT_DESTROYER_NAME, new ItemBuilder(Material.TNT), new DestroyerKitLevel());
	}

	public static class DestroyerKitLevel extends SheepWarsKitLevel {

		public DestroyerKitLevel() {
			super(Message.Messages.KIT_DESTROYER_DESCRIPTION, "sheepwars.kit.destroyer", 10, 10);
		}
