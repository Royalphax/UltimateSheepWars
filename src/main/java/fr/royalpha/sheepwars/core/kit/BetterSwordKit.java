...
public class BetterSwordKit extends SheepWarsKit {
	...
	public BetterSwordKit() {
		super(2, Message.Messages.KIT_BETTER_SWORD_NAME, new ItemBuilder(Material.STONE_SWORD).hideAttributes(), new BetterSwordKitLevel());
	}

	public static class BetterSwordKitLevel extends SheepWarsKitLevel {

		public BetterSwordKitLevel() {
			super(Message.Messages.KIT_BETTER_SWORD_DESCRIPTION, "sheepwars.kit.bettersword", 10, 10);
		}
