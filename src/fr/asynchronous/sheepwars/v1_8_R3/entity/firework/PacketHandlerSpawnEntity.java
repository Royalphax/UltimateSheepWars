package fr.asynchronous.sheepwars.v1_8_R3.entity.firework;
 ...
 public class PacketHandlerSpawnEntity extends AbstractPacketHandler{
     ...
     private static Field fieldEntityId, fieldLocX, fieldLocY, fieldLocZ, fieldVelX, fieldVelY, fieldVelZ, fieldPitch, fieldYaw,
             fieldEntityTypeId, fieldData;
     ...
     public PacketHandlerSpawnEntity(int entityId, int entityTypeId, double x, double y, double z, float yaw, float pitch, int velocityX, int velocityY,
             int velocityZ, int data){
